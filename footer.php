    <footer class="wrapper">
        <div class="footer_inner">
            ...
            <ul class="footer_menu">
                ...
                <li><a href="<?= get_permalink(get_page_by_path('news')) ?>" class="nav_link footer_link">お知らせ</a></li>
        ...
        <a class="gototop" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow_wh.svg" alt="上に戻る"></a>
    </footer>
    <?php wp_footer(); ?>
</body>
</html>